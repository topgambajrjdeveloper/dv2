...
class AboutPage(models.Model):
    ...
    description_p1 = models.CharField(
        verbose_name=_("desc parrafo1"), max_length=255)
    description_p2 = models.CharField(
        verbose_name=_("desc parrafo2"), max_length=255)
    description_p3 = models.CharField(
        verbose_name=_("desc parrafo3"), max_length=255)
...
class ImagePilaAbout(models.Model):
    about = models.ForeignKey(
        AboutPage, on_delete=models.CASCADE, related_name="about_image")
    image = models.ImageField(verbose_name=_(
        "imagen de habilidades"), default="about/default.png", upload_to="about/",)
...
class ImageProjects(models.Model):
    project = models.ForeignKey(
        ProjectsPage, on_delete=models.CASCADE, related_name="project_image")
    image = models.ImageField(verbose_name=_(
        "imagen de habilidades"), default="project/default.png", upload_to="project/",)
    alt_text = models.CharField(verbose_name=_("titulo"), max_length=255)
...
class ExperiencePage(models.Model):
    ...
    desc = models.CharField(verbose_name=_(
        "descripcion de las tareas realizadas"), max_length=255)
